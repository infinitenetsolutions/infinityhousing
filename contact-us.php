            ...
            <div class="col-12">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">
                        <a href="index-2.html"> <i class="fas fa-home"></i> </a>
                    </li>
            ...
            <div class="col-lg-5">
                <div class="contact-address bg-light p-4">
                    <div class="d-flex mb-3">
                        ...
                        <div class="ms-3">
                            <h6>Address</h6>
                            <p>2nd Floor, Devdas Palace, Bistupur,Jamshedpur Jharkhand, India Pin – 831001</p>
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        <div class="contact-address-icon">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div class="ms-3">
                            <h6>Phone Number</h6>
                            <p>+91 9835796743 , +91 9470371443</p>
                        </div>
                    </div>
                    <div class="d-flex mb-3">
                        <div class="contact-address-icon">
